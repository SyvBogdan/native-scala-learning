package com.learning.basics.http
...
import com.learning.basics.http.session.MyScalaSession
...
object SessionHttpServer extends App with StrictLogging {
          ...
          path("do_login") {
            ...
            post {
              myRequiredSession { session => ctx =>
                ...
                println(s"Current session: $session")
